                                        ...
                                        <div class="col-xl-12">
                                            <div class="st-hero-text st-white">
                                                ...
                                                <div class="st-hero-btn"><a class='btn st-btn-custom st-solid-white'
                                                        href='{{route('about')}}'>Read More<i class="fas fa-plus-circle"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="st-iconbox st-style4 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <div class="st-iconbox-icon st-pink">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 432.4 432.4"
                                    xml:space="preserve">
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-about-text">
                                    ...
                                    <a class='btn st-btn-custom st-accent btn-md' href='{{route('about')}}'>Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="st-product st-style1">
                                        <div class="st-product-in">
                                            ...
                                            <div class="st-product-thumb">
                                                <a href='{{ route('shop.detail', $item->id) }}'><img style="width: 465px ; height: 300px; object-fit: cover" src="{{asset('storage/images/'.$item->thunm)}}"
                                                        alt="Product"></a>
                                                <div class="st-product-tools">
                                                    <ul>
                                                        <li><a href="{{ route('shop.detail', $item->id) }}"><i class="fas fa-eye"></i></a></li>
                                                        <li><a href="{{ route('shop_cart.add_to_cart', $item->id) }}"><i class="fas fa-shopping-cart"></i></a>
                                                        </li>
                                            ...
                                            <div class="st-product-details">
                                                <div class="st-product-label">
                                                    <p class="st-product-price">${{$item->discount}}</p>
                                                    <div class="st-star" data-star="5">
                                                        <div class="st-star-in"></div>
                                                    </div>
                                                </div>
                                                <h4 class="st-product-title"><a href='{{ route('shop.detail', $item->id) }}'>{{$item->title}}</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- .slick-slide-in -->
