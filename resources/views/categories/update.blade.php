                            ...
                            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        value="{{ $category->categoryName }}" name="categoryName" id="categoryTitle">
                                </div>
                                <div class="col-12 pt-3">
                                    <label class="form-label">Description</label>
                                    <textarea rows="5" name="des" class="form-control form-control-sm">{{ $category->description }}</textarea>
                                </div>
                            ...
                            <div class="row justify-content-between g-3">
                                <div class="col-xxl-4 col-6 col-xs-12">
                                    <form action="{{ route('categories.index') }}" class="row g-2">
                                        <div class="col-4">
                                            <button type="submit" class="btn btn-sm btn-primary w-100">New
                                                category</button>
                                        </div>
                                    </form>
                                </div>
