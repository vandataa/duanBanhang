                ...
                <div class="col-xxl-9 col-lg-8">
                    ...
                    <div class="panel mb-25">
                        ...
                        <div class="panel-body">
                            <textarea name="description" id="" cols="125" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="panel mb-25">
                        <div class="panel-header">
                            ...
                            <div class="tab-content product-data-tab" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-video" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-10">
                                            <input type="url" name="video" class="form-control form-control-sm"
                                                name="video_link" placeholder="Video Link">
                                ...
                                <div class="cat-group">
                                    @foreach ($category as $cate)
                                        <div class="form-check">
                                            <input type="hidden" name="count" value=" {{ $cate->count }}">
